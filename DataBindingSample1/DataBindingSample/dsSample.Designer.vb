...
Partial Public Class dsSample
    ...
    Partial Public Class CompaniesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCompaniesRow(ByVal CompanyCode As String, ByVal CompanyName As String, ByVal Address As String, ByVal City As String, ByVal ZipCode As String, ByVal OfficePhone As String, ByVal ContactName As String, ByVal ContactPhone As String) As CompaniesRow
            Dim rowCompaniesRow As CompaniesRow = CType(Me.NewRow,CompaniesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, CompanyCode, CompanyName, Address, City, ZipCode, OfficePhone, ContactName, ContactPhone}
    ...
    Partial Public Class CompaniesRow
        ...
        Public Function IsCityNull() As Boolean
            Return Me.IsNull(Me.tableCompanies.CityColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetCityNull()
            Me(Me.tableCompanies.CityColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace dsSampleTableAdapters
    ...
    Partial Public Class CompaniesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Companies] ([CompanyCode], [CompanyName], [Address], [City], [ZipCod"& _ 
                "e], [OfficePhone], [ContactName], [ContactPhone]) VALUES (@p1, @p2, @p3, @p4, @p"& _ 
                "5, @p6, @p7, @p8)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlServerCe.SqlCeParameter("@p4", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, true, 0, 0, "City", Global.System.Data.DataRowVersion.Current, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Companies] SET [CompanyCode] = @p1, [CompanyName] = @p2, [Address] = @p3,"& _ 
                " [City] = @p4, [ZipCode] = @p5, [OfficePhone] = @p6, [ContactName] = @p7, [Conta"& _ 
                "ctPhone] = @p8 WHERE (([CompanyID] = @p9))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlServerCe.SqlCeParameter("@p4", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, true, 0, 0, "City", Global.System.Data.DataRowVersion.Current, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlServerCe.SqlCeParameter("@p9", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, true, 0, 0, "CompanyID", Global.System.Data.DataRowVersion.Original, Nothing))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [CompanyID], [CompanyCode], [CompanyName], [Address], [City], [ZipCode], ["& _ 
                "OfficePhone], [ContactName], [ContactPhone] FROM [Companies]"
        ...
        Public Overloads Overridable Function Update(ByVal p1 As String, ByVal p2 As String, ByVal p3 As String, ByVal p4 As String, ByVal p5 As String, ByVal p6 As String, ByVal p7 As String, ByVal p8 As String, ByVal p9 As Integer) As Integer
            If (p1 Is Nothing) Then
